---
id: "19412"
identifier: "vbpl-19412"
title: "Luật Hợp tác xã số 18/2003/QH11"
country: "vn"
jurisdiction: "vn"
...
view_count: 1
source_url: "https://vbpl.moj.gov.vn/van-ban/chi-tiet/19412"
signers:
  - "Nguyễn Văn An"
job_titles:
  - "Chủ tịch Quốc hội"
...
3. Tự chủ, tự chịu trách nhiệmvà cùng có lợi: hợp tác xã tự chủ và tự chịutrách nhiệm về kết quả hoạt động sảnxuất, kinh doanh; tự quyết định về phân phối thu nhập.
...
4. Bảo toàn và phát triển vốn hoạtđộng của hợp tác xã; quản lý và sử dụngđất được Nhà nước giao theo quy định của pháp luật;
...
Tổ chức chính trị và các tổ chứcchính trị - xã hội trong hợp tác xã hoạt độngtrong khuôn khổ Hiến pháp, pháp luật và theo Điều lệ của tổ chức mình phù hợp vớiquy định của pháp luật.
...
- p) Chế độ xử lý vi phạm Điều lệ hợp tác xã và nguyên tắc giảiquyết tranh chấp nội bộ;
...
Cán bộ, công chức được tham giahợp tác xã với tư cách là xã viên theo quy định của Điều lệ hợp tác xãnhưng không được trực tiếp quản lý vàđiều hành hợp tác xã.
...
1. Được ưu tiên làm việc cho hợptác xã và được trả công lao động theo quy định của Điều lệ hợptác xã;
2. Hưởng lãi chia theo vốn góp, công sức đóng góp và theo mức độ sửdụng dịch vụ của hợp tác xã;
...
7. Ứ ng cử, bầu cử vào Ban quản trị,Chủ nhiệm hợp tác xã, Ban kiểm soát và những chứcdanh được bầu khác của hợp tác xã;
...
2. Hợp tác xã có nhiều xã viên thì có thểtổ chức Đại hội đại biểu xã viên;việc bầu đại biểu xã viên đi dự Đạihội đại biểu xã viên do Điều lệ hợptác xã quy định. Đại hội đại biểuxã viên và Đại hội toàn thể xã viên (sau đây gọi chung là Đại hội xã viên) có quyềnvà nhiệm vụ như nhau.
...
14. Các đối tượng đượchợp tác xã đóng bảo hiểm xã hội theo chính sách bảo hiểm xã hội bắt buộc của Nhànước;
...
- h) Tuyển dụng lao động, trừ trường hợp thuộc thẩmquyền của Ban quản trị hợp tác xã;
...
- e) Tuyển dụng lao động theo uỷ quyền của Ban quản trị hợptác xã;
...
2. Giám sát hoạt động của Ban quảntrị, Chủ nhiệm hợp tác xã và xã viên theo đúng pháp luật và Điều lệ, Nội quy hợptác xã;
...
- b) Ban quản trị không triệu tậpĐại hội xã viên bất thường theo yêu cầu của xã viên quy định tại khoản 4Điều 21 của Luật này.
# CHƯƠNG V TÀI SẢN VÀ TÀI CHÍNH CỦA HỢP TÁC XÃ
...
1. Hợp tác xã phải lập quỹ phát triểnsản xuất và quỹ dự phòng theo hướng dẫn của Chính phủ; các quỹ khác doĐiều lệ hợp tác xã và Đại hội xã viênquy định phù hợp với điều kiện cụthể của từng hợp tác xã. Tỷ lệ cụ thểtrích lập các quỹ do Đại hội xã viên quyếtđịnh.
...
3. Sau khi thanh toán hết các khoản nợ vàcác chi phí cho việc giải thể hợp tác xã, việc xửlý tài sản, vốn, quỹ khác còn lại của hợptác xã được thực hiện theo quy định tại Điều này, các quy định kháccủa pháp luật có liên quan và Điều lệ hợptác xã.
...
# CHƯƠNG VI TỔ CHỨC LẠI, GIẢI THỂ, PHÁ SẢN HỢPTÁC XÃ
...
- c) Lập hồ sơ đăng ký kinh doanhcủa hợp tác xã hợp nhất theo quy định tại Điều 13 của Luật này và gửiđến cơ quan đăng ký kinh doanh;
...
5. Trong trường hợp không đồngý với quyết định của Uỷ ban nhân dân vềviệc giải thể hợp tác xã thì hợp tác xã có quyềnkhiếu nại đến cơ quan nhà nước có thẩmquyền hoặc khởi kiện tại Toà án theo quy định của pháp luật.
...
# CHƯƠNG VII LIÊN HIỆP HỢP TÁC XÃ, LIÊN MINH HỢP TÁC XÃ
...
- b) Các bộ, cơ quan ngang bộ trong phạm vi nhiệm vụ, quyền hạn củamình có trách nhiệm thực hiện quản lý nhà nướcđối với hợp tác xã;
