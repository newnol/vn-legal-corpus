---
id: "56896"
identifier: "vbpl-56896"
title: "Nghị định số 32/2015/NĐ-CP Về quản lý chi phí đầu tư xây dựng"
country: "vn"
jurisdiction: "vn"
jurisdiction_name: "Trung ương"
scope: "Trung ương"
doc_num: "32/2015/NĐ-CP"
doc_type: "Nghị định"
rank: "nghi-dinh"
...
content_file_name: "VanBanGoc_32.2015.NĐ.CP.pdf"
content_doc_file_name: "32.2015.ND.CP.doc"
has_content_html: true
is_translation_doc: false
is_consolidated_document: false
is_administrative_document: false
view_count: 1
source_url: "https://vbpl.moj.gov.vn/van-ban/chi-tiet/56896"
signers:
  - "Nguyễn Tấn Dũng"
job_titles:
  - "Thủ tướng"
...
- Chi phí xây dựng được xác định trên cơ sở khối lượng nhóm, loại công tác xây dựng, đơn vị kết cấu hoặc bộ phận công trình và giá xây dựng tổng hợp tương ứng với nhóm, loại công tác xây dựng, đơn vị kết cấu hoặc bộ phận công trình được đo bóc, tính toán và một số chi phí có liên quan khác dự tính;
...
3. Định mức xây dựng được công bố quy định tại Khoản 1, 2 Điều này là cơ sở để chủ đầu tư sử dụng, vận dụng, tham khảo khi xác định tổng mức đầu tư, dự toán xây dựng và quản lý chi phí đầu tư xây dựng.
...
5. Chủ đầu tư chậm thực hiện quyết toán theo quy định tại khoản 3 Điều này bị xử lý theo quy định tại Nghị định về xử phạt quy định hành chính trong hoạt động xây dựng; kinh doanh bất động sản; khai khác, kinh doanh vật liệu xây dựng; quản lý công trình hạ tầng kỹ thuật; quản lý phát triển nhà ở và công sở.
...
# Chương VII
QUYỀN VÀ NGHĨA VỤ CỦA NGƯỜI QUYẾT ĐỊNH ĐẦU TƯ, CHỦ ĐẦU TƯ,
...
- đ) Thuê các tổ chức tư vấn quản lý chi phí đầu tư xây dựng đủ kiện năng lực theo quy định tại Nghị định về quản lý dự án đầu tư xây dựng để thực hiện lập, thẩm tra, kiểm soát, quản lý chi phí đầu tư xây dựng;
- e) Được quyền đòi bồi thường hoặc khởi kiện ra toà án theo quy định của pháp luật đòi bồi thường các thiệt hại do việc chậm trễ của cơ quan thanh toán vốn đầu tư;
