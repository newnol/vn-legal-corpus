...
content_file_name: "VanBanGoc_91.L2025-Luat Bao ve du lieu ca nhan.pdf"
...
view_count: 23
source_url: "https://vbpl.moj.gov.vn/van-ban/chi-tiet/179252"
signers:
  - "Trần Thanh Mẫn"
job_titles:
  - "Chủ tịch Quốc hội"
...
## Điều 4. Quyền và nghĩa vụ của chủ thẻ dữ liệu cá nhân
...
2. Cân trở hoạt động bảo vệ dữ liệu cá nhân.
...
4. Sự đồng ý của chủ thẻ dữ liệu cá nhân phải bảo đảm các nguyên tắc sau đây:
...
1. Các trường hợp chuyên dữ liệu cá nhân xuyên biên giới bao gồm:
...
1. Bên kiểm soát dữ liệu cá nhân, bên kiểm soát và xử lý dữ liệu cá nhân lặp, lưu trữ hồ sơ đánh giá tác động xử lý dữ liệu cá nhân và gửi 01 bản chính cho cơ quan chuyên trách bảo vệ dữ liệu cá nhân trong thời gian 60 ngày kể từ ngày đầu tiên xử lý dữ liệu cá nhân, trừ trường hợp quy định tại khoản 6 Điều này.
