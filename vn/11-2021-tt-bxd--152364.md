---
id: "152364"
identifier: "vbpl-152364"
title: "Thông tư số 11/2021/TT-BXD Hướng dẫn một số nội dung xác định và quản lý chi phí đầu tư xây dựng"
country: "vn"
jurisdiction: "vn"
jurisdiction_name: "Trung ương"
scope: "Trung ương"
doc_num: "11/2021/TT-BXD"
doc_type: "Thông tư"
rank: "thong-tu"
...
- đ) Chi phí thí nghiệm, hiệu chỉnh, chi phí chạy thử thiết bị theo yêu cầu kỹ thuật (nếu có) xác định bằng dự toán phù hợp nội dung công việc thực hiện.
4. Chi phí quản lý dự án trong dự toán xây dựng công trình xác định theo quy định tại khoản 4 Điều 12 và Điều 30 Nghị định số 10/2021/NĐ-CP trên cơ sở định mức tỷ lệ phần trăm (%) đã tính toán trong tổng mức đầu tư xây dựng; hoặc bằng dự toán phù hợp với chi phí quản lý dự án trong tổng mức đầu tư được duyệt. Định mức chi phí quản lý dự án quy định tại Thông tư ban hành định mức xây dựng.
...
2. Chi phí khác có liên quan của gói thầu được xác định theo quy định tại điểm b khoản 1, điểm b khoản 2, điểm b khoản 3, điểm b khoản 4 Điều 6 Thông tư này phù hợp với điều kiện cụ thể, tính chất của gói thầu và dự toán xây dựng công trình đã được phê duyệt.
...
3. Cơ cấu chi phí sử dụng để xác định chỉ số giá xây dựng được tổng hợp từ số liệu thống kê, phải phù hợp với cơ cấu chi phí theo quy định về quản lý chi phí đầu tư xây dựng và được sử dụng cố định cho đến khi có sự thay đổi thời điểm gốc quy định tại điểm a khoản 5 Điều này.
